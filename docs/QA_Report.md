...
**Generiert am**: 23.4.2026, 10:04:10
...
| Guard: bundle:runtime Freshness<br><small>Bundle 912s veraltet (juengste Quelle: src/components/TSidePanel.ts). Bitte "npm run bundle:runtime" ausfuehren!</small> | System-Guard | 🛡️ **Schlecht-Test** | OK/Erwartet | Abgelehnt | ❌ |
...
| navigate_stage Auto-Remap<br><small>GoToSpiel.stageId=stage_import_1776931367593_mg (erwartet: stage_import_1776931367593_mg), BackToLobby.stageId=stage_import_1776931367593_0m (erwartet: stage_import_1776931367593_0m)</small> | Stage-Import | 🛡️ **Schlecht-Test** | OK/Erwartet | OK/Erhalten | ✅ |
