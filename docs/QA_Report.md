...
**Generiert am**: 3.5.2026, 09:54:06
...
| Guard: bundle:runtime Freshness<br><small>Bundle 56302s veraltet (juengste Quelle: src/runtime/actions/handlers/ObjectPoolActions.ts). Bitte "npm run bundle:runtime" ausfuehren!</small> | System-Guard | 🛡️ **Schlecht-Test** | OK/Erwartet | Abgelehnt | ❌ |
...
| Export-Integrität: GameRuntime.ts<br><small>Hash geändert! Erwartet: FD50B56126D83294..., Aktuell: 68F33D6929076CDF... → npx tsx tests/export_integrity.test.ts --update</small> | Export-Integrität | 🛡️ **Schlecht-Test** | OK/Erwartet | Abgelehnt | ❌ |
...
| navigate_stage Auto-Remap<br><small>GoToSpiel.stageId=stage_import_1777794736719_sv (erwartet: stage_import_1777794736719_sv), BackToLobby.stageId=stage_import_1777794736719_r1 (erwartet: stage_import_1777794736719_r1)</small> | Stage-Import | 🛡️ **Schlecht-Test** | OK/Erwartet | OK/Erhalten | ✅ |
