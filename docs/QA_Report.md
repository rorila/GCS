...
**Generiert am**: 17.4.2026, 18:40:01
**Status**: ✅ ALLE TESTS BESTANDEN

## 📊 Visuelle Übersicht
```mermaid
pie title Test-Status (Gesamt: 165)
    "Bestanden ✅" : 165
    "Fehlgeschlagen ❌" : 0
```
...
| navigate_stage Auto-Remap<br><small>GoToSpiel.stageId=stage_import_1776443945987_lv (erwartet: stage_import_1776443945987_lv), BackToLobby.stageId=stage_import_1776443945987_it (erwartet: stage_import_1776443945987_it)</small> | Stage-Import | 🛡️ **Schlecht-Test** | OK/Erwartet | OK/Erhalten | ✅ |
