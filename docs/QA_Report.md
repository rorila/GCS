...
**Generiert am**: 8.5.2026, 18:37:23
...
| Guard: bundle:runtime Freshness<br><small>Bundle 27928s veraltet (juengste Quelle: src/runtime/GameLoopManager.ts). Bitte "npm run bundle:runtime" ausfuehren!</small> | System-Guard | 🛡️ **Schlecht-Test** | OK/Erwartet | Abgelehnt | ❌ |
...
| navigate_stage Auto-Remap<br><small>GoToSpiel.stageId=stage_import_1778258159902_jp (erwartet: stage_import_1778258159902_jp), BackToLobby.stageId=stage_import_1778258159902_2v (erwartet: stage_import_1778258159902_2v)</small> | Stage-Import | 🛡️ **Schlecht-Test** | OK/Erwartet | OK/Erhalten | ✅ |
