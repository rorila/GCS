...
**Generiert am**: 14.4.2026, 13:46:18
**Status**: ✅ ALLE TESTS BESTANDEN

## 📊 Visuelle Übersicht
```mermaid
pie title Test-Status (Gesamt: 161)
    "Bestanden ✅" : 161
    "Fehlgeschlagen ❌" : 0
```
...
| navigate_stage Auto-Remap<br><small>GoToSpiel.stageId=stage_import_1776167132900_vm (erwartet: stage_import_1776167132900_vm), BackToLobby.stageId=stage_import_1776167132900_ab (erwartet: stage_import_1776167132900_ab)</small> | Stage-Import | 🛡️ **Schlecht-Test** | OK/Erwartet | OK/Erhalten | ✅ |
