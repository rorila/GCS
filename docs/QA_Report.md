...
**Generiert am**: 29.4.2026, 19:16:07
...
| Guard: Keine unerlaubten console.* Aufrufe<br><small>Zu viele: src/components/TDebugLog.ts:103, src/components/TDebugLog.ts:125, src/components/TDebugLog.ts:286, src/components/TDebugLog.ts:379, src/editor/EditorViewManager.ts:300, src/editor/EditorViewManager.ts:307, src/editor/EditorViewManager.ts:309, src/editor/inspector/InspectorContextBuilder.ts:250, src/editor/inspector/renderers/InspectorSectionRenderer.ts:629, src/editor/inspector/renderers/InspectorSectionRenderer.ts:638, src/editor/inspector/renderers/InspectorSectionRenderer.ts:640, src/editor/inspector/renderers/InspectorSectionRenderer.ts:642, src/editor/inspector/renderers/InspectorSectionRenderer.ts:646, src/editor/inspector/renderers/InspectorSectionRenderer.ts:649, src/editor/inspector/renderers/InspectorSectionRenderer.ts:652, src/editor/services/EditorInteractionManager.ts:99, src/editor/services/EditorInteractionManager.ts:106, src/editor/services/EditorInteractionManager.ts:123, src/editor/services/renderers/ComplexComponentRenderer.ts:401, src/editor/services/renderers/TextObjectRenderer.ts:124, src/editor/services/renderers/VirtualGamepadRenderer.ts:72, src/editor/services/StageInteractionManager.ts:180, src/editor/services/StageInteractionManager.ts:199, src/editor/services/StageInteractionManager.ts:521, src/editor/services/StageInteractionManager.ts:631, src/editor/services/StageInteractionManager.ts:632, src/editor/services/StageInteractionManager.ts:665, src/editor/services/StageInteractionManager.ts:719, src/editor/services/StageRenderer.ts:821, src/editor/services/StageRenderer.ts:827, src/export/GameExporter.ts:463, src/export/GameExporter.ts:467, src/export/GameExporter.ts:560, src/utils/TauriFSAdapter.ts:21, src/utils/TauriFSAdapter.ts:60</small> | System-Guard | 🛡️ **Schlecht-Test** | OK/Erwartet | Abgelehnt | ❌ |
| Guard: Dateigroesse < 1000 Zeilen<br><small>Zu gross: src/editor/EditorViewManager.ts (1164), src/editor/flow/FlowAction.ts (1021), src/editor/inspector/InspectorRenderer.ts (1205), src/editor/inspector/renderers/InspectorSectionRenderer.ts (1044), src/editor/services/StageRenderer.ts (1140), src/runtime/GameRuntime.ts (1108), src/services/AgentController.ts (1302)</small> | System-Guard | 🛡️ **Schlecht-Test** | OK/Erwartet | Abgelehnt | ❌ |
...
| Rename Object: LoginButton → SignInButton<br><small>Object=false, ActionTarget=true</small> | Refactoring | 🛡️ **Schlecht-Test** | OK/Erwartet | Abgelehnt | ❌ |
...
| navigate_stage Auto-Remap<br><small>GoToSpiel.stageId=stage_import_1777482881918_7n (erwartet: stage_import_1777482881918_7n), BackToLobby.stageId=stage_import_1777482881918_ib (erwartet: stage_import_1777482881918_ib)</small> | Stage-Import | 🛡️ **Schlecht-Test** | OK/Erwartet | OK/Erhalten | ✅ |
