...
test.describe('Deep Integration: Editor & Engine', () => {
    ...
    // → wird später als eigener UseCase neu implementiert

    // Test 4: Stage-Switch-Action (Anforderung 4)
    // → wird später als eigener UseCase implementiert: "Action-Typ ändern"
});
