...
check('Dreizehn Oberflächen und sieben Server-Stages',p.stages.length===21);
...
// Super-Sidebar fuehrt nur zu Super-Bereichen; ueber die Anmeldung kommt
// man an die volle Navigationszeile (admin/house) und zur Einwahl.
for(const id of ['stage_admin_login','stage_admin','stage_house','stage_super','stage_super_houses','stage_super_admins','stage_library','stage_admin_login'])await navigate(id);
