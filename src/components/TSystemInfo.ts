...
export class TSystemInfo extends TComponent {
    ...
    public hardwareConcurrency: number;  // CPU cores
    public deviceMemory: number;          // RAM in GB
    public maxTouchPoints: number;        // Touch support

    constructor(name: string = 'SystemInfo') {
        super(name);
        ...
        this.deviceMemory = (navigator as any).deviceMemory || 0;
