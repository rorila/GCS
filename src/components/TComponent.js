export class TComponent {
    id;
    name;
    className; // Explicit className for production builds
    parent = null;
    children = [];
    Tasks; // EventName -> TaskName
    scope = 'stage'; // Visibility scope
    isVariable = false; // Flag for variable-like components
