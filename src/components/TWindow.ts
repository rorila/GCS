...
export class TWindow extends TComponent {
    ...
    public getInspectorProperties(): TPropertyDef[] {
        return [
            ...
            { name: 'style.fontFamily', label: 'Schriftart', type: 'string', group: 'TYPOGRAFIE' },
            ...
            { name: 'style.textAlign', label: 'Ausrichtung', type: 'select', group: 'TYPOGRAFIE', options: ['left', 'center', 'right'], inline: true },
