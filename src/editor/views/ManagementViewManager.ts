...
export class ManagementViewManager {
    ...
    public renderManagementView(panel: HTMLElement) {
        ...
        const managers = [
            ...
            { id: 'KIGenerate', label: 'KI generieren', emoji: '🤖' }
        ];
        ...
        } else if (this.host.selectedManager === 'KIGenerate') {
            this.renderKIGenerateView(content);
    ...
    private renderImportView(parent: HTMLElement): void {
        ...
        importFeatureBtn.onclick = async () => {
            ...
            try {
                ...
                const importResult = io.importScript(parsedFeature, { conflictStrategy: 'reuse', targetStageId });
