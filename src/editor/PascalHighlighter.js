        ...
        tokens.forEach(token => {
            ...
            while ((match = token.regex.exec(code)) !== null) {
                ...
                if (token.name === 'procedure' || token.name === 'variable') {
                    ...
                    if (this.KEYWORDS.includes(text.toUpperCase()) || this.TYPES.includes(text.toUpperCase()))
                        continue;
                }
                matches.push({
                    start: match.index,
